...
/**
 * BasicCurrentTransactionCtrl - controller
 */
function CurrentTransactionCtrl($scope, $rootScope, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, API, $modal, $compile, STATUS, TransactionsService) {
    ...
    var ajaxOptions = {
        ...
        url: API.base + API.transaction_user + $rootScope.loggedInUser.id,
        type: 'GET',
    ...
    $scope.approveTransaction = function(transaction_id) {
        var modalInstance = $modal.open({
            ...
            templateUrl: 'views/basic/transactions/modal.confirm.approve.html'
        });
    ...
    $scope.denyTransaction = function(transaction_id) {
        var modalInstance = $modal.open({
            controller: 'BasicTransactionsConfirmModalCtrl',
            templateUrl: 'views/basic/transactions/modal.confirm.deny.html'
        });
        modalInstance.result.then(function(modalResult) {
...
angular
    .module('oss')
    .controller('BasicCurrentTransactionCtrl', CurrentTransactionCtrl);