...
function ContractsCtrl($scope, $rootScope, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder, API, $modal, $compile, ContractsService) {
    ...
    $scope.createFolder = function() {
        var modalInstance = $modal.open({
            controller: 'PowerCreateContractModalCtrl',
            templateUrl: 'views/power/contracts/modal.contract.create.html',
            resolve: {
                folderId: function() {
    ...
    $scope.edit = function(type, id) {
        /*var modalInstance = $modal.open({
            controller: 'PowerEditContractModalCtrl',
            templateUrl: 'views/power/contracts/modal.contract.edit.html',
            resolve: {
                type: function() {
                    return type;
                },
    ...
    $scope.delete = function(id) {
        var modalInstance = $modal.open({
            controller: 'PowerContractDeleteConfirmModalCtrl',
            templateUrl: 'views/power/contracts/modal.delete.confirm.html'
        });
        modalInstance.result.then(function(modalResult) {
    ...
    $scope.uploadFile = function() {
        var modalInstance = $modal.open({
            controller: 'PowerContractUploadModalCtrl',
            templateUrl: 'views/power/contracts/modal.contract.upload.html'
        });
        modalInstance.result.then(function(modalResult) {
            console.log(modalResult);
        });
...
angular
    .module('oss')
    .controller('PowerContractsCtrl', ContractsCtrl);